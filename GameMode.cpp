...
void GameMode::GeneratePlayer()
{
	...
	Player* _player = Level::SpawnActor(Player(30.0f, Vector2f(50.0f, 50.0f), "Ship_" + to_string(GetRandomNumberInRange(1, 5)), PNG, IntRect(Vector2i(), Vector2i(32, 32))));
...
void GameMode::GenerateAsteroid()
{
	...
	Asteroid* _asteroid = Level::SpawnActor(Asteroid(10.0f, _convexShapePoints, _finalPath, BIG));
...
void GameMode::GenerateUFO()
{
	...
	UFO* _ufo = Level::SpawnActor(UFO(10.0f, _convexShapePoints, _finalPath));
